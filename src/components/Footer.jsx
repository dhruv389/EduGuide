...
function Footer() {
  return (
    <footer className="bg-blue-600 text-sm  mt-[2rem] tracking-wider flex flex-col justify-center items-center text-white rounded-t-[1rem] pt-[2.4rem] h-[16rem]">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex  md:flex-row justify-between">
          ...
          <div className="md:flex-col md:space-y-4">
            <h3 className="text-gray-400 mb-2">Company</h3>
            <ul className="list-none">
          ...
          <div className="md:flex-col md:space-y-4">
            <h3 className="text-gray-400 mb-2">Legal</h3>
            <ul className="list-none">
      ...
      <div className="text-center border-t-2 pt-3 border-gray-500 mt-1">
