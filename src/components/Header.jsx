...
const toggleDropdown = () => {
  ...
  return (
    <div className='flex flex-col gap-4 w-screen  bg-blue-600 px-16'>
        ...
        <div className="w-[30%] text-sm flex gap-2 items-center justify-around">
                <Link to="/" className="text-gray-200">Home</Link>
                <Link className="text-gray-200">About</Link>
                <Link className="text-gray-200">Services</Link>
                <Link className="text-gray-200">Contact</Link>
        </div>
